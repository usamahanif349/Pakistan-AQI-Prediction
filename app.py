...
<style>
    ...
    .masthead .smogbar {{
        ...
        border-radius: 999px;
        background: linear-gradient(90deg, {ACCENT['predict']}, {ACCENT['map']},
                                     {ACCENT['trend']}, {ACCENT['compare']});
    }}
    .masthead .standfirst {{
    ...
    /* ---------- tab bar: each tab keeps its own colour ---------- */
    ...
    .stTabs [data-baseweb="tab-list"] > button:nth-child(1) {{ color: {ACCENT['predict']} !important; }}
    .stTabs [data-baseweb="tab-list"] > button:nth-child(2) {{ color: {ACCENT['map']} !important; }}
    .stTabs [data-baseweb="tab-list"] > button:nth-child(3) {{ color: {ACCENT['trend']} !important; }}
    .stTabs [data-baseweb="tab-list"] > button:nth-child(4) {{ color: {ACCENT['compare']} !important; }}
    .stTabs [data-baseweb="tab-list"] > button p {{ color: inherit !important; font-weight: 700; }}

    .stTabs [data-baseweb="tab-list"] > button:nth-child(1)[aria-selected="true"] {{
        background-color: rgba(34, 211, 238, 0.18); border-bottom-color: {ACCENT['predict']};
    }}
    .stTabs [data-baseweb="tab-list"] > button:nth-child(2)[aria-selected="true"] {{
        background-color: rgba(52, 211, 153, 0.18); border-bottom-color: {ACCENT['map']};
    }}
    .stTabs [data-baseweb="tab-list"] > button:nth-child(3)[aria-selected="true"] {{
        background-color: rgba(167, 139, 250, 0.20); border-bottom-color: {ACCENT['trend']};
    }}
    .stTabs [data-baseweb="tab-list"] > button:nth-child(4)[aria-selected="true"] {{
        background-color: rgba(251, 191, 36, 0.20); border-bottom-color: {ACCENT['compare']};
    }}
